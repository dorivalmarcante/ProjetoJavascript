...
console.log(`Ele tem ${personagem.caracteristicas.forca} de força, ${personagem.caracteristicas.magia} de magia e ${personagem.caracteristicas.stamina} de stamina.`);
